...
/**
 * Will return the path and default mangacore-node configuration. It will search for the
 * configuration file in the "~/.mangacoin" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.mangacoin');
  var defaultConfigFile = path.resolve(defaultPath, './mangacore-node.json');
