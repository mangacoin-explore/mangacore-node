...
/**
 * Will return the path and mangacore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'mangacore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'mangacore-node.json'))
  };
}
