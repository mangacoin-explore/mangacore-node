...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `mangacore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ mangacore-node add wallet-service');
      console.log('    $ mangacore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ mangacore-node remove wallet-service');
      console.log('    $ mangacore-node remove insight-api');
      console.log();
    });
